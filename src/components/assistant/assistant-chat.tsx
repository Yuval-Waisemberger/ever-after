...
export function AssistantChat({ initialThreadId, initialMessages }: { initialThreadId: string | null; initialMessages: AssistantMessage[] }) {
  ...
  return (
    <div className="assistant-surface mt-8 grid overflow-hidden border bg-paper lg:grid-cols-[250px_1fr]">
      <aside className="assistant-prompts border-b p-5 lg:border-b-0 lg:border-r">
      ...
      <section className="assistant-conversation flex min-h-[620px] flex-col">
