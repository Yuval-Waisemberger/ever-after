...
export function GuestSummary({ summary, estimate }: { summary: Summary; estimate: number | null }) {
  ...
  return <section className="guest-summary mt-7" aria-labelledby="guest-summary-heading">
    <div className="guest-summary-intro">
      <div><p className="eyebrow">Your people, together</p><h2 id="guest-summary-heading" className="font-display mt-2 text-2xl">Every reply brings the day closer</h2>{!summary.invited ? <p className="mt-2 text-sm text-ink-soft">Your invitation picture begins with your first invited guest.</p> : null}</div>
