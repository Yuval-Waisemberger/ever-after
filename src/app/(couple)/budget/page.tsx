...
export default async function BudgetPage({ searchParams }: PageProps<"/budget">) {
  ...
  const metrics = [
    ...
    ["Available", summary.availableMinor, "Funds after commitments and actual spending"],
  ] as const;
  return (
