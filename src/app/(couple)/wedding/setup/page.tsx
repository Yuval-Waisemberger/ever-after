...
export default async function WeddingSetupPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-5 py-8 sm:px-8 lg:px-10 lg:py-12">
      ...
      <SetupWizard values={{ weddingDate: wedding.wedding_date, venueStatus: wedding.venue_status, venueName: wedding.venue_name, guestCount: wedding.guest_count, preferredArea: wedding.preferred_area, eventType: wedding.event_type, styles: wedding.styles, priorities: wedding.priorities, bookedCategories: wedding.booked_categories, totalBudgetMinor: wedding.total_budget_minor == null ? null : Number(wedding.total_budget_minor) }} />
    </main>
  );
}
