      ...
      <div className="wedding-overview mt-8">
        <DashboardCard title="Our Tasks" eyebrow="At a glance" className="dashboard-tasks-card" footer={summaryLink("/tasks", "Manage tasks")}>
          <div className="task-summary-grid grid grid-cols-3 gap-3 text-center">
            <div><ListChecks className="mx-auto size-5 text-wine" /><strong className="mt-2 block text-2xl"><AnimatedValue value={taskSummary.open} /></strong><span className="text-xs text-ink-soft">Open</span></div>
            <div><CalendarClock className="mx-auto size-5 text-[#9A611C]" /><strong className="mt-2 block text-2xl"><AnimatedValue value={taskSummary.dueThisWeek} /></strong><span className="text-xs text-ink-soft">Due this week</span></div>
        ...
        <DashboardCard title="Guest List" eyebrow="Guests" className="dashboard-guests-card" footer={summaryLink("/guests", guestSummary.invitationParties ? "See guest list" : "Open guest list")}>
          <GuestDashboardSummary summary={guestSummary} />
        </DashboardCard>

        <DashboardCard title="Wedding Assistant" eyebrow="Grounded guidance" className="dashboard-assistant-card" footer={summaryLink("/assistant", "Ask the Assistant")}>
