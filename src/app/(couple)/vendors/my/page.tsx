  ...
  return (
    <main className="mx-auto max-w-6xl px-5 py-8 sm:px-8 lg:px-10 lg:py-12">
      ...
      <details id="add-external-vendor" className="mt-7 rounded-lg border bg-paper p-5 sm:p-6">
        <summary className="font-display text-2xl text-wine">Add a vendor not in Marketplace</summary>
        <p className="mt-2 text-sm leading-6 text-ink-soft">This vendor stays private to your Couple account and will never appear in public search.</p>
        <div className="mt-6"><ExternalVendorForm taxonomy={taxonomy} /></div>
      </details>
      ...
      <div className="mt-6 space-y-4">
        {relationships.map((relationship) => {
          ...
          return (
            <article key={relationship.id} className="our-vendor-card rounded-2xl border bg-paper p-5 sm:p-6" data-vendor-source={isExternal ? "external" : "marketplace"}>
              ...
              <details className="mt-5 border-t pt-4">
                ...
                <div className="mt-5">
                  {externalValue ? <ExternalVendorForm taxonomy={taxonomy} value={externalValue} /> : (
                    <form action={setVendorStatus} className="grid gap-4 sm:grid-cols-2">
