...
export default async function VendorProfilePage() {
  ...
  return (
    <main className="ea-consistent-page vendor-account mx-auto max-w-5xl px-5 py-8 sm:px-8 lg:px-10 lg:py-12">
