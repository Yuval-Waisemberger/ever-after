...
export const REAL_AI_LIMITS = Object.freeze({ globalTurns: 500, coupleTurns: 150, activePerCouple: 1 });
...
export const guardrailCode = z.enum(["INVALID_INPUT", "NOT_AUTHORIZED", "REQUEST_CONFLICT", "GLOBAL_QUOTA_EXHAUSTED", "COUPLE_QUOTA_EXHAUSTED", "REQUEST_ACTIVE", "INVALID_TRANSITION", "UNSUPPORTED_TRANSACTION", "ADMISSION_UNAVAILABLE"]);
